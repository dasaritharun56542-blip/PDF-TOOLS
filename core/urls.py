...
urlpatterns = [
    ...
    path('process/<str:tool_slug>', views.process_tool, name='process_tool_noslash'),
    path('process/', views.process_tool, name='process_tool_generic'),
    path('process', views.process_tool, name='process_tool_generic_noslash'),
    path('status/<uuid:task_id>/', views.get_status, name='get_status'),
    path('status/<uuid:task_id>', views.get_status, name='get_status_noslash'),
    path('download/<int:file_id>/', views.download_file, name='download_file'),
    path('download/<int:file_id>', views.download_file, name='download_file_noslash'),
