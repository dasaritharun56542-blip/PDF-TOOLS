...
urlpatterns = [
    ...
    path('api/payments/create-order/', views.api_create_payment_order, name='api_create_payment_order'),
    path('api/payments/verify/', views.api_verify_payment, name='api_verify_payment'),
    path('api/payments/webhook', views.phonepe_webhook, name='api_payments_webhook'),
    path('api/payments/webhook/', views.phonepe_webhook, name='api_payments_webhook_slash'),
    ...
    path('api/payments/status/<str:order_id>/', views.payment_status_api, name='api_payment_status'),
    path('api/admin/payments/<int:payment_id>/refund/', views.api_admin_refund_payment, name='api_admin_refund_payment'),
    ...
    path('api/legal/config/', views.api_get_legal_config, name='api_get_legal_config'),
    path('api/legal/refund-request/', views.api_submit_refund_request, name='api_submit_refund_request'),
    path('api/legal/my-refund-requests/', views.api_get_my_refund_requests, name='api_get_my_refund_requests'),
    path('api/legal/record-consent/', views.api_record_user_consent, name='api_record_user_consent'),
    path('api/admin/refund-requests/', views.api_admin_get_refund_requests, name='api_admin_get_refund_requests'),
    path('api/admin/refund-requests/<int:request_id>/process/', views.api_admin_process_refund_request, name='api_admin_process_refund_request'),
]
